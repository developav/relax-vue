          ...
          <nav class="header__nav">
            <div class="header__logo">
              ...
              <ul class="header__nav-list">
                  <li class="header__nav-list-item"><a class="header__nav-list-link" href="#">Главная</a></li>
                  <li class="header__nav-list-item"><a class="header__nav-list-link" href="#">Посты</a></li>
                  <li class="header__nav-list-item"><a class="header__nav-list-link" href="#">Статьи</a></li>
                  <li class="header__nav-list-item"><a class="header__nav-list-link" href="#">Теги</a></li>
                  <li class="header__nav-list-item"><a class="header__nav-list-link" href="#">Темы</a></li>
                  <li class="header__nav-list-item"><a class="header__nav-list-link" href="#">Контакты</a></li>
              </ul>
          </nav>
